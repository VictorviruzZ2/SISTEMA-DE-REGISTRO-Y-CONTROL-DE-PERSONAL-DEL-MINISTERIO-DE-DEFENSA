                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos </h1> 
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="annoegre" placeholder="Año de Egreso">
                                    <input type="text" class="form-control mb-3" name="annoser" placeholder="Años de Servicio">
                                    ...
                                    <input type="text" class="form-control mb-3" name="permiso" placeholder="Permisos">
